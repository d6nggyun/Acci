...
public interface LawRepository extends JpaRepository<Law, Long> {
    ...
    @Query("""
    SELECT new refresh.acci.domain.vectorDb.presentation.dto.res.RelatedLawsResponse(
        l.name,
        l.content
    )
    FROM Law l
...
""")
    List<RelatedLawsResponse> findAllLawsByAnalysisId(@Param("analysisId") UUID analysisId);
